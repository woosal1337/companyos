...
Frontend monorepo for CompanyOS, a multi-tenant B2B coordination layer. Orgs, teams, projects, Linear-style tasks, meetings with transcripts and AI summaries, notes, and org settings including BYOK AI provider keys and custom AI users.
