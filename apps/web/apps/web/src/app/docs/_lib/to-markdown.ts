...
const DOCS_ORIGIN = "https://docs.company.chele.bi";
const APP_ORIGIN = "https://company.chele.bi";
...
export function allPagesToMarkdown(): string {
  const preamble = [
    ...
    `Web app: ${APP_ORIGIN}/app · Docs: ${DOCS_ORIGIN} · MCP endpoint: ${APP_ORIGIN.replace("company.", "api.company.")}/api/v1/mcp`,
  ].join("\n\n");
