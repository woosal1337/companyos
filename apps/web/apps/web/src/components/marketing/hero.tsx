    ...
    <Section spacing="xl" className="relative overflow-hidden bg-canvas">
      ...
      <Container className="relative">
        <div className="flex max-w-3xl flex-col items-start text-left">
          <SectionNumber index="0.0" label="The coordination layer" />
          <h1 className="mt-7 max-w-3xl text-pretty text-two-tone font-display text-hero">
            <b>The coordination layer</b> for your whole company.
          </h1>
          <p className="mt-6 max-w-md text-lead text-muted-foreground">
            Projects, meetings, and tasks in one place. Every decision keeps its
            context, and AI runs on your own key.
          </p>
