        ...
        <div className="flex flex-col gap-10">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            ...
            <p className="max-w-xs text-small text-muted-foreground">
              Teams run their week inside CompanyOS.
            </p>
          </div>
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            <BoldQuote
              tone="lavender"
              quote="We stopped chasing decisions across four tools. Now the meeting, the task, and the owner all live in one place, and nothing slips between standups."
              name="Mara Velasquez"
              role="Head of Operations, Northwind"
            />
            <BoldQuote
              tone="acid"
              quote="Our own keys, our own data, one model of the company. I wired CompanyOS into our stack in an afternoon and it has held up under real load since."
              name="Daniel Okoye"
